...
enum TraditionalChineseHKStrings {
    static let values: [AppStringKey: String] = [
        .appName: "Jenkins Buddy", .jobs: "工作", .settings: "設定", .jenkins: "Jenkins", .notifications: "通知",
        .serverURL: "Jenkins 網址", .serverURLHelp: "包括通訊協定及任何 Jenkins 內容路徑。", .username: "使用者名稱",
        .apiToken: "API 權杖", .apiTokenHelp: "安全地儲存在登入鑰匙圈中。",
        .permissionsHelp: "需要可見工作的 Overall/Read 及 Job/Read 權限。", .refreshInterval: "重新整理間隔",
        .seconds: "秒", .testConnection: "測試連線", .connectionSuccessful: "連線成功",
        .connectionChangeWarning: "更改 Jenkins 網址或使用者會關閉已開啟的工作分頁並重設通知基準。",
        ...
        .monitoringNote: "已開啟的工作分頁會受到監控。關閉工作分頁會停止其通知。",
        ...
        .notifyBuildRecovered: "建置已恢復", .playSound: "播放聲音", .refresh: "重新整理", .loadingJobs: "正在載入工作…",
        .noJobs: "找不到 Jenkins 工作。", .configureJenkins: "設定 Jenkins 連線以瀏覽工作。", .openSettings: "開啟設定",
        .openInJenkins: "在 Jenkins 中開啟", .detailView: "詳細檢視", .cardView: "卡片檢視", .searchJobs: "搜尋工作",
        ...
        .closeTab: "關閉分頁", .jobDetails: "工作詳細資料", .noBuilds: "沒有可用的建置。", .loadingJob: "正在載入工作…",
        .retry: "再試一次", .online: "在線", .offline: "離線", .updatedNow: "剛剛更新", .monitoredJobs: "%d 個受監控的工作",
